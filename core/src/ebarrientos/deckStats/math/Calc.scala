...
object Calc {
   ...
   *
   * Some of the rules:
   * - A colored symbol counts once towards it's color
   * - A generic mana symbol counts for as much as it represents
   * - A hybrid mana symbol counts for half towards each thing it represents
   */
  def manaSymbols(
      d: Deck,
